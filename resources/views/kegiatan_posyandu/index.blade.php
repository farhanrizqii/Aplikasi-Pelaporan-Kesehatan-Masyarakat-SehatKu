<x-app-layout>
    ...
    <style>
        ...
        /* Search button dengan label untuk accessibility */
        .btn-cari {
            ...
            <div class="data-card">
                <div class="text-gray-900 dark:text-gray-100">
                    ...
                    <div class="action-buttons-container"> 
                        <a href="{{ route('kegiatan-posyandu.create') }}" class="btn-tambah">
                            <i class="fas fa-plus"></i>
                            <span>Tambah Jadwal Kegiatan</span>
                        </a>
                        <a href="{{ route('kegiatan-posyandu.export') }}" class="btn-ekspor">
                    ...
                    <!-- Search Form -->
                    <form method="GET" action="{{ route('kegiatan-posyandu.index') }}" class="flex items-center w-full md:w-1/3 mb-8">
                        <input type="text" name="search" placeholder="Cari Kegiatan atau Wilayah..." 
                            value="{{ request('search') }}"
                            class="search-input"
                            aria-label="Cari kegiatan posyandu">
                        ...
                        @if (request('search'))
                            <a href="{{ route('kegiatan-posyandu.index') }}" class="text-sm text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-600 font-semibold ml-3">Reset</a>
                        @endif
                    </form>
                    ...
                    <div class="overflow-x-auto">
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    @foreach ($kegiatans as $index => $k)
                                        <tr>
                                            <td class="whitespace-nowrap text-center">{{ $index + $kegiatans->firstItem() }}</td>
                                            ...
                                            <td class="whitespace-nowrap text-gray-600 dark:text-gray-300">
                                                <span class="font-semibold">{{ $k->wilayah->kelurahan ?? 'N/A' }}</span>
                                                @if ($k->wilayah->rt)
                                            ...
                                            <td class="whitespace-nowrap text-center space-x-2">
                                                <a href="{{ route('kegiatan-posyandu.show', $k) }}" class="action-link link-detail">
                                                    <i class="fas fa-eye"></i>Detail
                                                </a>

                                                <a href="{{ route('kegiatan-posyandu.edit', $k) }}" class="action-link link-edit">
                        ...
                        @else
                            <p class="text-center text-gray-500 dark:text-gray-400 py-8">Tidak ada kegiatan ditemukan</p>
                        @endif
