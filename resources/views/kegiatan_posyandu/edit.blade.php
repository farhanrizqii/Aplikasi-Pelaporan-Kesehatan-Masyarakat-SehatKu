            ...
            <div class="data-card">
                <div class="form-content">
                    <h3 class="form-title">
                        ...
                        <span>Edit Jadwal Kegiatan Posyandu</span>
                    </h3>
                    ...
                    <form action="{{ route('kegiatan-posyandu.update', $kegiatanPosyandu) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="jenis_kegiatan" 
                                id="jenis_kegiatan" 
                                value="{{ old('jenis_kegiatan', $kegiatanPosyandu->jenis_kegiatan) }}" 
                                required 
                                class="form-input"
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    name="tanggal" 
                                    id="tanggal" 
                                    value="{{ old('tanggal', $kegiatanPosyandu->tanggal) }}" 
                                    required 
                                    class="form-input">
                                @error('tanggal')
                                    <p class="error-message">
                            ...
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    name="jumlah_peserta" 
                                    id="jumlah_peserta" 
                                    value="{{ old('jumlah_peserta', $kegiatanPosyandu->jumlah_peserta) }}" 
                                    class="form-input"
                        ...
                        <div class="form-group">
                            ...
                            <textarea 
                                ...
                                rows="4" 
                                class="form-textarea"
                                placeholder="Tambahkan catatan atau informasi penting tentang kegiatan ini...">{{ old('keterangan', $kegiatanPosyandu->keterangan) }}</textarea>
                            @error('keterangan')
                                <p class="error-message">
                                    <i class="fas fa-exclamation-circle"></i>
                                    {{ $message }}
