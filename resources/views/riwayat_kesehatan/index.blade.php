            ...
            <div class="data-card">
                <div class="text-gray-900 dark:text-gray-100">
                    ...
                    <div class="action-buttons-container"> 
                        <a href="{{ route('riwayat-kesehatan.create') }}" class="btn-tambah">
                            <i class="fas fa-plus"></i>
                            <span>Catat Riwayat Baru</span>
                        </a>
                        
                        <!-- TOMBOL EKSPOR EXCEL BARU -->
                        <a href="{{ route('riwayat-kesehatan.export') }}" class="btn-ekspor">
                    ...
                    <!-- Form Pencarian -->
                    <form method="GET" action="{{ route('riwayat-kesehatan.index') }}" class="flex items-center w-full md:w-1/3 mb-8">
                        <input type="text" name="search" placeholder="Cari Penduduk atau Penyakit..." 
                            value="{{ request('search') }}"
                            class="search-input"
                            aria-label="Cari riwayat kesehatan">
                        ...
                        @if (request('search'))
                            <a href="{{ route('riwayat-kesehatan.index') }}" class="text-sm text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-600 font-semibold ml-3">Reset</a>
                        @endif
                    </form>
                    ...
                    <div class="overflow-x-auto">
                            ...
                            <table class="data-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left">Penduduk</th>
                                        <th class="text-left">Penyakit</th>
                                        <th class="text-left">Tanggal Pemeriksaan</th>
                                        <th class="text-left">Status/Hasil</th>
                                ...
                                <tbody>
                                    @foreach ($riwayats as $index => $riwayat)
                                        <tr>
                                            <td class="whitespace-nowrap text-center">{{ $index + $riwayats->firstItem() }}</td>
                                            ...
                                            <td class="whitespace-nowrap font-semibold text-gray-800 dark:text-gray-100">
                                                {{ $riwayat->hasil }}
                                            </td>
                                            
                                            <td class="whitespace-nowrap text-center space-x-2">
                                                <a href="{{ route('riwayat-kesehatan.show', $riwayat) }}" class="action-link link-detail">
                                                    <i class="fas fa-eye"></i>Detail
                                                </a>

                                                <a href="{{ route('riwayat-kesehatan.edit', $riwayat) }}" class="action-link link-edit">
                        ...
                        @else
                            <p class="text-center text-gray-500 dark:text-gray-400 py-8">Belum ada data riwayat kesehatan yang tercatat.</p>
                        @endif
                        
                        <div class="pagination-container">
                             <div class="text-sm text-gray-700 dark:text-gray-400">
                                Showing {{ $riwayats->firstItem() }} to {{ $riwayats->lastItem() }} of {{ $riwayats->total() }} results
                            </div>
